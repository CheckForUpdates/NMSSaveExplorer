...
public class ExosuitTechController extends BaseInventoryController {
    @Override protected String getInventoryName() { return "Exosuit Technology"; }
    ...
    protected JsonArray getSlotsArray(JsonObject root) {
        try {
            ...
            JsonObject tech = player.getAsJsonObject("PMT");
            if (tech == null) return new JsonArray();
            JsonArray slots = tech.getAsJsonArray(":No");
    ...
    protected JsonArray getValidSlotsArray(JsonObject root) {
        try {
            ...
            JsonObject tech = player.getAsJsonObject("PMT");
            if (tech == null) return new JsonArray();
            JsonArray valid = tech.getAsJsonArray("hl?");
